...
\subsubsubsection{Sričių panašumo metodas}
\begin{figure}[ht!]
	\centering
...
\subsubsubsection{Bendradarbiavimo filtravimo rezultatai}
\indent
...
\begin{center}
	\captionof{table}{BF rezultatai taikomi RS duomenims DS1}
	\begin{tabular}{||c c c c c c ||} 
...
\end{center}
\begin{center}
	\captionof{table}{BF rezultatai taikomi RS duomenims DS2}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
...
\subsubsubsection{Architektūra 1: Sričių panašumo metodas}
...
\begin{center}
	\captionof{table}{Panašumo tarp kategorijų matrica gauta taikant $GDTS$ metodą}
	\begin{tabular}{||c c c c c c||} 
		\hline
		Kategorijos & $X_1$ & $X_2$ & $X_3$ & $X_4$ & $X_5$ \\ [0.5ex] 
		\hline\hline
...
\begin{center}
	\captionof{table}{Sričių panašumo matrica taikant $CMDS$ metodą}
	\begin{tabular}{||c c c c c c||} 
		\hline
		Kategorijos & $X_1$ & $X_2$ & $X_3$ & $X_4$ & $X_5$ \\ [0.5ex] 
		\hline\hline
...
\end{center}
\begin{center}
	\captionof{table}{$AVGDS$ rezultatai taikomi duomenų rinkiniui DS1}
	\begin{tabular}{||c c c c c c ||} 
		Duomenų rinkinio poaibis &  $MAE$ & $MAUE$ & $RMSE$ & $RC$ & $UC$ \\
		\hline
...
\begin{center}
	\captionof{table}{$MAXDS$ rezultatai taikomi duomenų rinkiniui DS1}
	\begin{tabular}{||c c c c c c ||} 
		Duomenų rinkinio poaibis  & $MAE$ & $MAUE$ & $RMSE$ & $RC$ & $UC$ \\
		\hline
...
\begin{center}
	\captionof{table}{$AVGDS$ rezultatai taikomi duomenų rinkiniui DS1 ir naudojant panašumus, išskaičiuotus iš kategorijų matricos}
	\begin{tabular}{||c c c c c c ||} 
		Duomenų rinkinio poaibis  & $MAE$ & $MAUE$ & $RMSE$ & $RC$ & $UC$ \\
		\hline
...
\subsubsubsection{Architektūra 2: Propagavimo metodas}
\indent
...
\begin{center}
	\captionof{table}{$SHORTMULTI$ rezultatai taikomi RS duomenims DS1}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & $RC$ & $UC$ \\
		\hline
...
\begin{center}
	\captionof{table}{$SHORTARI$ rezultatai taikomi RS duomenims DS1}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & $RC$ & $UC$ \\
		\hline
...
\subsubsubsection{Architektūra 3: Sričių panašumo ir propagavimo metodas}
\indent
...
\begin{center}
	\captionof{table}{$AVGDS$ + $SHORTMULTI$ (sričių panašumai gauti taikant $GTDS$), su slenksčiu 0.6, rezultatai taikomi RS duomenims DS1}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
...
\begin{center}
	\captionof{table}{$AVGDS$ + $SHORTMULTI$ rezultatai taikomi RS duomenims DS2}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
...
\begin{center}
	\captionof{table}{$AVGDS$ + $SHORTMULTI$ + $AVGDS$ rezultatai taikomi RS duomenims DS2}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
...
\subsubsubsection{Architektūra 4: Propagavimo ir sričių panašumo metodas}
\indent
...
\begin{center}
	\captionof{table}{$SHORTMULTI$ +  $AVGDS$ (su sričių panašumais, gautais naudojant $GTDS$), su slenksčiu 0.6, rezultatai taikomi RS duomenims DS1}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
...
\end{center}
\begin{center}
	\captionof{table}{$SHORTMULTI$ + $AVGDS$ (su sričių panašumais, gautais naudojant $GTDS$), su slenksčiu 0.3, rezultatai taikomi RS duomenims DS2}
	\begin{tabular}{||c c c c c c||} 
		Duomenų rinkinio poaibis & $MAE$ & $MAUE$ & $RMSE$ & RC & UC \\
		\hline
